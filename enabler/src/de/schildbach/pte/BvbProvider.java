...
public class BvbProvider extends AbstractEfaProvider {
    private final static HttpUrl API_BASE = HttpUrl.parse("https://www.efa-bw.de/bvb/");
    private final static HttpUrl API_BASE_MOBILE = HttpUrl.parse("https://www.efa-bw.de/android_bvb/");
