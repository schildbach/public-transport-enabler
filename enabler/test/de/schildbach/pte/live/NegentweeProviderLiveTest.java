...
public class NegentweeProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStations() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(new Location(LocationType.STATION, "station-amsterdam-centraal"));
        print(result);
    ...
    public void shortTrip() throws Exception {
        final QueryTripsResult result = queryTrips(
                ...
                new Location(LocationType.STATION, "station-amsterdam-zuid", null, "Amsterdam Zuid"), new Date(), true, null,
    ...
    public void earlierTrip() throws Exception {
        final QueryTripsResult result1 = queryTrips(
                new Location(LocationType.STATION, "station-amsterdam-centraal", null, "Amsterdam Centraal"), null,
                new Location(LocationType.STATION, "station-rotterdam-centraal", null, "Rotterdam Centraal"), new Date(), true, null,
                NetworkProvider.WalkSpeed.FAST, NetworkProvider.Accessibility.NEUTRAL);
        print(result1);
    ...
    public void ambiguousTrip() throws Exception {
        final QueryTripsResult result = queryTrips(
                new Location(LocationType.ANY, null, null, "Amsterdam Zuid"),
                new Location(LocationType.STATION, "station-amsterdam-centraal", null, "Amsterdam Centraal"),
                new Location(LocationType.ANY, null, null, "Rotterdam Centraal"),
                new Date(), true, null,
                NetworkProvider.WalkSpeed.FAST, NetworkProvider.Accessibility.NEUTRAL);
        print(result);
    ...
    public void longTrip() throws Exception {
        final QueryTripsResult result = queryTrips(
                ...
                new Location(LocationType.STATION, "breda/bushalte-cornelis-florisstraat", null, "Cornelis Florisstraat"), new Date(), true, null,
                NetworkProvider.WalkSpeed.FAST, NetworkProvider.Accessibility.NEUTRAL);
        print(result);
        assertEquals(QueryTripsResult.Status.OK, result.status);
    }
