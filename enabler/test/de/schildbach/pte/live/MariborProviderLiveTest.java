...
public class MariborProviderLiveTest extends AbstractProviderLiveTest
{
	...
	{
		final QueryTripsResult result = queryTrips(new Location(LocationType.STATION, 63202999, null, "Graz Marburger Straße"), null, new Location(
				LocationType.STATION, 63201746, null, "Flughafen Graz Bahnhof"), new Date(), true, Product.ALL, WalkSpeed.NORMAL,
