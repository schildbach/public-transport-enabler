...
import de.schildbach.pte.BsAsProvider;
...
public class BsAsProviderLiveTest extends AbstractNavitiaProviderLiveTest {
	
	public BsAsProviderLiveTest()
	{
		super(new BsAsProvider(secretProperty("navitia.authorization")));
	}
