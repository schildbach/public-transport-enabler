...
public class HslProviderLiveTest extends AbstractProviderLiveTest
{
	...
	{
		final QueryTripsResult result = queryTrips(new Location(LocationType.STATION, null, "", "Gustaf Hällströmin katu 1"), null,
				new Location(LocationType.STATION, null, "", "Tyynenmerenkatu 11"), new Date(), true, Product.ALL, WalkSpeed.NORMAL,
