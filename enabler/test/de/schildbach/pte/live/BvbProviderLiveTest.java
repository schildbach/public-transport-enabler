...
public class BvbProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void shortTrip() throws Exception {
        final QueryTripsResult result = queryTrips(new Location(LocationType.STATION, "10000", null, "Bahnhof"), null,
                new Location(LocationType.STATION, "86", null, "Markthalle"), new Date(), true, Product.ALL,
