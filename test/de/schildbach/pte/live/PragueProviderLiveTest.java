...
import de.schildbach.pte.PragueProvider;
 ...
 * @author Filip Hejsek
 */
public class PragueProviderLiveTest extends AbstractNavitiaProviderLiveTest {
    public PragueProviderLiveTest() {
        super(new PragueProvider(secretProperty("navitia.authorization")));
    }
